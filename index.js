...
app.get('/pairing', async (req, res) => {
    let num = req.query.number;
	 ...
	 //const sparkyses = await sparky.sendMessage(sparky.user.id, { document: sessionsparky, mimetype: `application/json`, fileName: `creds.json` });
				...
				await sparky.sendMessage(sparky.user.id, { text: `_*Thanks for choosing LOFFY-MD-BOT*_

*REPO*
https://github.com/mackbotzzzzz/LUFFY-MD
            
            
*ᴊᴏɪɴ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ғᴏʀ ᴍᴏʀᴇ ϙᴜᴇʀʏ*
https://chat.whatsapp.com/HF7KwWp0Q8rBTteekGZKu5?mode=ac_t
            
*Cʜᴀɴɴᴇʟ ʟɪɴᴋ*
https://whatsapp.com/channel/0029VbApLH1EwEjvXxCGF41d
